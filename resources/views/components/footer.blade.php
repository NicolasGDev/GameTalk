<section class="pt-16 pb-7 bg-gray-950">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col sm:flex-row items-center justify-between pb-14 border-b border-gray-500 gap-8">
            ...
            <div class="flex items-center gap-4 [&>a]:hover:bg-main ">
                <a href="javascript:;"
                    class="p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-main hover:text-black ">
                        ...
                        <div class="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                            <div class="flex items-start black">
                                <input id="checked-checkbox" type="checkbox" value=""
                                    class="w-5 h-5 aspect-square appearance-none cursor-pointer border border-gray-600 bg-transparent  rounded-md mr-2 hover:border-gray-400 hover:bg-gray-900 checked:bg-no-repeat checked:bg-center checked:border-main checked:bg-main"
                                    checked="">
                                <label for="checked-checkbox" class="text-sm font-normal cursor-pointer text-gray-400">
                                    I agree with <a href="javascript:;" class="text-main">Privacy Policy</a> and
                                    <a href="javascript:;" class="text-main">Terms of Condition</a></label>
                            </div>
                            <input type="submit" value="Send"
                                class="text-black text-base font-semibold py-3 px-7 rounded-full cursor-pointer bg-main transition-all duration-500 hover:bg-mainClaro hover:text-gray-900">
                        </div>
        ...
        <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
            <span class="text-sm font-normal text-gray-400">
                <a href="https://pagedone.io/" class="">Gametalk</a> 2024, All rights reserved.
            </span>
